...
imfile1 = kb_input('Enter the file name of the first image (default=''calib1.jpg''): ', 'calib1.jpg');
im1 = imread(imfile1);
imfile2 = kb_input('Enter the file name of the second image (default=''calib2.jpg''): ', 'calib2.jpg');
im2 = imread(imfile2);
